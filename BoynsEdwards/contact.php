        ...
        <article id="contact-article">
            ...
            <div id="socialMedia">
                <a target="_blank" href="mailto:gooding.lucinda@gmail.com">
                    <img class="contactLogo" src="contactImages/email.png" id="contactSocial" title="Send me an email">
                </a>
                <a target="_blank" href="tel:07714643503">
                    <img class="contactLogo" src="contactImages/phone.png" id="contactSocial" title="Call me">
                </a>
            </div> <br>
            <h1>Social Media</h1> <br> <br>
            <div id="socialMedia">
                <a target="_blank" href="https://www.facebook.com/lucinda.gooding">
                    <img class="socialLogo" src="contactImages/facebook.png" id="contactSocial" title="Like me on Facebook">
                </a>
                <a target="_blank" href="http://picbear.com/cindygooding">
                    <img class="socialLogo" src="contactImages/instagram.png" id="contactSocial" title="Follow me on Instagram">
                </a>
                <a target="_blank" href="https://www.linkedin.com/in/lucinda-gooding-8425a210a/">
                    <img class="socialLogo" src="contactImages/linkedin.png" id="contactSocial" title="Connect with me on LinkedIn">
                </a>
                <a target="_blank" href="https://plus.google.com/111162230368655597956">
                    <img class="socialLogo" src="contactImages/googleplus.png" id="contactSocial" title="Follow me on Google+">
                </a>
            </div>

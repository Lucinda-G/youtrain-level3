...
<!--            <div id="forDeleteS1"></div>-->
    ...
    <section id="setOutcomes">
        
                                        <!--///Set Outcome///-->
        <form id="outcomeForm">
            <h3>Set Monthly Outcome</h3>
            <h4>(Rent, Bills, etc.)</h4>
            <ul>
                <li>
                    <label for="outDate">Date due: </label>
                    <input id="outDate" type="date" name="outDate">
                </li>
                <li>
                    <label for="outDescription">Description: </label>
                    <input id="outDescription" type="text" name="outDescription">
                </li>
                <li>
                    <label for="outcomeAmount">Amount: </label>
                    <input id="outcomeAmount" type="text" name="outcomeAmount">
                </li>
                <li>
                    <button id="outcomeBtn" onclick="addOutcome()" type="button">Add Outcome</button>
                </li>
            </ul>

            <table id="setOutcomeTable" border="1">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Description</th>
...
<!--
        <form id="spendingForm">
            <h3>Spending Outcome</h3>
            <h4>(Eating Out, Clothes, etc.)</h4>
            <ul>
                <li>
                    <label for="spendDate">Date of Spend: </label>
                    <input id="spendDate" type="date" name="spendDate">
                </li>
                <li>
                    <label for="spendDescription">Description: </label>
                    <input id="spendDescription" type="text" name="spendDescription">
                </li>
                <li>
                    <label for="spendAmount">Amount: </label>
                    <input id="spendAmount" type="text" name="spendAmount">
                </li>
                <li>
                    <button id="spendBtn" onclick="addSpending()" type="button">Add Outcome</button>
                </li>
            </ul>

            <table id="spendingTable" border="1">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Description</th>
